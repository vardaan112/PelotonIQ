...
/**
 * Examine the actual AG2R team page structure
 */
async function examineAG2RTeamPage() {
  try {
    console.log('=== EXAMINING AG2R TEAM PAGE STRUCTURE ===\n');
    
    const teamUrl = 'https://www.procyclingstats.com/team/decathlon-ag2r-la-mondiale-2025';
    ...
    const filename = '/tmp/ag2r_team_page.html';
    ...
    // Look specifically for teamlist class
    console.log('\n=== TEAMLIST ELEMENTS ===');
    ...
    // Look for rider names anywhere
    console.log('=== RIDER NAMES SEARCH ===');
    const commonCyclingNames = ['POGACAR', 'ALMEIDA', 'VINGEGAARD', 'EVENEPOEL'];
    commonCyclingNames.forEach(name => {
...
examineAG2RTeamPage()
  .then(() => {
    console.log('AG2R team page examination completed');
    process.exit(0);
  })
  .catch(error => {
