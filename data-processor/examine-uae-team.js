...
/**
 * Examine the UAE Team Emirates page structure
 */
async function examineUAETeamPage() {
  try {
    console.log('=== EXAMINING UAE TEAM EMIRATES PAGE STRUCTURE ===\n');
    ...
    const famousRiders = ['POGACAR', 'ALMEIDA', 'MAJKA', 'AYUSO'];
...
examineUAETeamPage()
  .then(() => {
    console.log('UAE team page examination completed');
    process.exit(0);
  })
  .catch(error => {
